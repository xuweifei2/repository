...
public class DateUtil {
	...
	public static final String DATA_PATTON_YYYY_MM = "yyyy-MM";
	...
	public static final String TIME_PATTON_HHMM = "HHmm";
	public static final String DATA_PATTON_YYMMDD = "yyMMdd";
   ...
   /**
    * @Title stepMonth   
    * @Description TODO(当前时间加上或减去指定月份后的日期)   
    * @param month
    * @return Date
    */
	...
	public static String timeFormatStr(Integer time, String format, String formatA) {
		try {
			SimpleDateFormat sdf = new SimpleDateFormat(format);
			Date date = sdf.parse(time + "");
			SimpleDateFormat sdfA = new SimpleDateFormat(formatA);
	...
	public static Integer getIntegerDate(Date date, String format) {
		if(null == date) {
			return null;
		}
		SimpleDateFormat sdf = new SimpleDateFormat(format);
	...
	/**
	 * 获取当前日期前一天时间(yyyy-MM-dd)
	 */
	public static String getBeforeDate_yyyy_MM_dd() {
		Date dNow = new Date(); // 当前时间
		Date dBefore = new Date();
		Calendar calendar = Calendar.getInstance(); // 得到日历
		calendar.setTime(dNow); // 把当前时间赋给日历
	...
	public static Date getTodayDate() {
		DateFormat dateFormat = new SimpleDateFormat(DATE_PATTON_DEFAULT);
	...
	public static Date getTodayDate(Date newDate) {
		DateFormat dateFormat = new SimpleDateFormat(DATE_PATTON_DEFAULT);
	...
	/**
	 * 获取当前日期前一天时间(yyyy-MM-dd HH:mm:ss)
	 * 
	 * @return
	 */
	...
	public static String formatDate(Date aTs_Datetime) {
		return formatDate(aTs_Datetime, DATE_PATTON_DEFAULT);
	}
	 ...
	 * @return
	 */
	public static String format5(Date aTs_Datetime) {
	...
	public static double daysOfTwoDate(Date bDate, Date eDate) {
		...
		if (bDate == null || eDate == null || bDate.before(eDate) || bDate.equals(tempDate)) {
			return 0;
		}
		bg.setTime(bDate);
		eg.setTime(eDate);
	 ...
	 */
	public static int turnDateToDateInt(Date date) {
		Calendar c = Calendar.getInstance();
		c.setTime(date);
	...
	public static Date getDateByLong(Long timestamp){
		Date date = null;
		if(timestamp != null){
			date = new Date(Long.parseLong(String.valueOf(timestamp)));
		}
		return date;
	}
	 ...
	 * 最大unix时间
	 */
	public static Date getMaxUnixDate() {
		int num = Integer.MAX_VALUE;
		Date date = formatIntDate(num);
		return date;
	}

	public static int getMonthsBefore(Short months) {
		Date sourceDate = new Date();
        Calendar c = Calendar.getInstance();
        c.setTime(sourceDate);
        c.add(Calendar.MONTH, 0 - months);
        sourceDate = c.getTime();
		return getIntegerDate(sourceDate, DATA_PATTON_YYYYMM);
	}

	/**
	 * 	n个月,m天后的时间
	 */
	public static Date getDateBeforeMonthDay(Date date, int months, int days) {
		Date sourceDate = new Date();
        Calendar c = Calendar.getInstance();
        c.setTime(sourceDate);
